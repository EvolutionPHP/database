...
abstract class DB_forge {
		...
		if (is_string($field))
		{
			...
			else
			{
				if (strpos($field, ' ') === FALSE)
				{
					...
					$this->display_error('Field information is required for that operation.');
				}
	...
	public function create_table($table, $if_not_exists = FALSE, array $attributes = array())
	{
		if ($table === '')
		{
			$this->display_error('A table name is required for that operation.');
		}
		else
		{
		...
		{
			$this->display_error('Field information is required.');
		}
	...
	public function drop_table($table_name, $if_exists = FALSE)
	{
		if ($table_name === '')
		{
			$this->db->display_error('db_table_name_required');
		}
